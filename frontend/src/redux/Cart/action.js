...
export const getCardData=(token)=>async (dispatch)=>{
  ...
  try {
        const res = await fetch("https://zauvijek-industry-mart.onrender.com/cart/", {
            method: "GET",
            headers: {
...
export const deleteItemFromCart=(id,token)=>async(dispatch)=>{
    ...
    try{
        ...
        const res = await fetch(`https://zauvijek-industry-mart.onrender.com/cart/delete/${id}`,{
            method: "DELETE",
            headers: {
                "Content-type": "application/json",
                "authorization":token
...
console.log(id)
    try{
        ...
        const res = await fetch(`https://zauvijek-industry-mart.onrender.com/cart/deleteAll/${id}`,{
            method: "DELETE",
            headers: {
                "Content-type": "application/json",
                "authorization":token
...
export const addToCart=(payload,token)=>async(dispatch)=>{
    ...
    try{
        ...
        const res = await fetch(`https://zauvijek-industry-mart.onrender.com/cart/add`,{
            method: "POST",
            headers: {
...
export const updateCart=(payload,id,token)=>async(dispatch)=>{
    ...
    try{
        ...
        const res = await fetch(`https://zauvijek-industry-mart.onrender.com/cart/update/${id}`,{
            method: "PATCH",
            headers: {
                "Content-type": "application/json",
                "authorization":token,
