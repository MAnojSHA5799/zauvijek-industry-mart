        ...
        <Box
          ...
          <form onSubmit={handlesubmit}>
                ...
                <FormControl  isRequired>
                  ...
                  <Select style={{color:"black"}} onChange={handlechange} value={gender} name="gender" placeholder="Select gender">
                ...
                <FormControl isRequired>
                  ...
                  <Text fontSize="sm" color="gray.600" mt={1}>
                    {role === 'buyer' ? 'Browse and purchase products' : 'Sell your products (requires admin approval)'}
                  </Text>
                </FormControl>
