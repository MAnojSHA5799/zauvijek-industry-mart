...
const Home = () => {
  ...
  let secAlmira = [
    {
      img: "https://3.imimg.com/data3/US/UL/MY-2/steel-almirah-125x125.jpg",
      title: "Steel Almirah",
      d1: "Godrej Steel Almirah",
      d2: "Office Steel Almirah",
      d3: "Bedroom Steel Almirah",
    },
    {
      img: "https://3.imimg.com/data3/OD/SQ/MY-2/wooden-almirah-125x125.jpg",
      title: "Wooden Almirah",
      d1: "Teak Wood Almirah",
      d2: "Designer Wooden Almirah",
      d3: "Traditional Wooden Almirah",
    },
    {
      img: "https://3.imimg.com/data3/XY/AG/MY-2/wardrobe-125x125.jpg",
      title: "Wardrobe",
      d1: "Sliding Door Wardrobe",
      d2: "2 Door Wardrobe",
      d3: "4 Door Wardrobe",
    },
    {
      img: "https://3.imimg.com/data3/BF/VD/MY-2/cupboards-125x125.jpg",
      title: "Cupboards",
      d1: "Wooden Cupboard",
      d2: "Plastic Cupboard",
      d3: "Kids Cupboard",
    ...
    {
      img: "https://3.imimg.com/data3/FG/QR/MY-2/file-cabinets-125x125.jpg",
      title: "File Cabinets",
      d1: "Steel File Cabinet",
      d2: "Wooden File Cabinet",
      d3: "Office File Storage",
    },
    {
      img: "https://3.imimg.com/data3/VR/JW/MY-2/modular-furniture-125x125.jpg",
      title: "Modular Furniture",
      d1: "Office Modular Furniture",
      d2: "Bedroom Modular Furniture",
      d3: "Kitchen Modular Furniture",
    },
  ];
  
  let hideAlmira = [
    {
      img: "https://3.imimg.com/data3/WE/YY/MY-2/office-lockers-125x125.jpg",
      title: "Office Lockers",
      d1: "Steel Office Locker",
      d2: "Multi-Door Locker",
      d3: "Personal Storage Locker",
    },
    {
      img: "https://3.imimg.com/data3/TW/FE/MY-2/dressing-table-125x125.jpg",
      title: "Dressing Tables",
      d1: "Wooden Dressing Table",
      d2: "Mirror Dressing Table",
      d3: "Modern Dressing Table",
    },
    {
      img: "https://3.imimg.com/data3/UT/BB/MY-2/plastic-almirah-125x125.jpg",
      title: "Plastic Almirah",
      d1: "Nilkamal Plastic Almirah",
      d2: "Kids Plastic Almirah",
      d3: "Portable Plastic Almirah",
    },
  ];
...
>
  ...
  <Flex height="100%" w="95%" m="auto" p="10px 0px">
    ...
    >
      <Box
        position="relative"
        backgroundImage="https://hm.imimg.com/imhome_gifs/almira.jpg"
      >
        <a href="/almira">
          <Button
            top="360px"
      ...
      <Image
        ...
        p="0px 20px 0px 0px"
        objectFit="cover"
        src="https://hm.imimg.com/imhome_gifs/almira.jpg"
      />
    </Box>
    <SimpleGrid
      height="100%"
    ...
    >
      ...
      {hideAlmira.map((el) => (
        <a href="/almira-category" key={el.title}>
          <Flex
            display={{ base: "none", md: "flex" }}
            p="10px"
            flexDirection={{ base: "column", sm: "row" }}
